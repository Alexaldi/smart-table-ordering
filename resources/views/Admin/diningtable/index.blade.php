                    ...
                    <div class="tm-page">
                        ...
                        <div class="tm-layout">
                            ...
                            <div class="tm-panel">
                                ...
                                @php
                                    $existingNumbers = $tables->pluck('table_number')->map(function($item) {
                                ...
                                <form action="{{ route('tables.store') }}" method="POST">
                                    ...
                                    <div class="tm-field-wrap">
                                        <label class="tm-field-label" for="table_number">Next Table Number / Name</label>
                                ...
                                <div class="tm-info-box">
                                    ...
                                    The system automatically detects missing table numbers and fills them in to keep the sequence in order.
                                </div>
                            </div>
                            ...
                            <div class="tm-right-col">
                                ...
                                <div class="tm-cards-grid" id="cardsGrid">
                                    @forelse($tables as $table)
                                        <div class="tm-table-card table-card-item" data-name="{{ strtolower($table->table_number) }}">
                                            ...
                                            <div class="tm-qr-area">
                                                <div id="qr-container-{{ $table->id }}">
                                                    {!! QrCode::size(130)->margin(0)->generate(url('/menu?token=' . ($table->qr_token ?? 'default'))) !!}
                                                </div>
                                            </div>

                                            <div class="tm-card-footer">
                                                <button onclick="printQR('{{ $table->table_number }}', 'qr-container-{{ $table->id }}')"
                                                        class="tm-action-btn">
                                            ...
                                            <form id="delete-form-{{ $table->id }}"
                                                ...
                                                method="POST"
                                                class="delete-form"
                                                data-type="Table {{ $table->table_number }}"
                                                style="display:none;">
                                                @csrf @method('DELETE')
                                            </form>
