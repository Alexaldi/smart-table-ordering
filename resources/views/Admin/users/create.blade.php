    ...
    <div class="sto-form-page">
        <div class="sto-child-nav">
            <ol class="sto-breadcrumb">
                ...
                <li><span class="active">Tambah User</span></li>
            </ol>
        ...
        <div class="sto-page-head">
            <div class="sto-title-wrap">
                <div class="sto-title-icon"><i class="fe fe-user-plus"></i></div>
                <h1 class="sto-page-title">Tambah User</h1>
            </div>
        </div>

        <form method="POST" action="{{ route('users.store') }}" class="sto-card">
            @csrf

            <div class="sto-grid">
                <div class="sto-field full">
                    <label for="name" class="sto-label">Nama</label>
                    <input id="name" type="text" name="name" value="{{ old('name') }}" class="sto-control @error('name') is-invalid @enderror">
                    @error('name') <div class="sto-error">{{ $message }}</div> @enderror
                </div>

                <div class="sto-field">
                    <label for="email" class="sto-label">Email</label>
                    <input id="email" type="email" name="email" value="{{ old('email') }}" class="sto-control @error('email') is-invalid @enderror">
                ...
                <div class="sto-field">
                    <label for="password" class="sto-label">Password</label>
                ...
                <div class="sto-field">
                    <label for="password_confirmation" class="sto-label">Konfirmasi Password</label>
                ...
                <div class="sto-field">
                    ...
                    <select id="is_active" name="is_active" class="sto-control @error('is_active') is-invalid @enderror">
                        <option value="1" @selected(old('is_active', '1') === '1')>Akun aktif</option>
                        <option value="0" @selected(old('is_active') === '0')>Akun nonaktif</option>
                    </select>
